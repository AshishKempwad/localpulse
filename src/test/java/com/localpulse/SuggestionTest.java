...
import static com.localpulse.util.Constants.Index.*;
...
public class SuggestionTest extends AbstractTest{
    ...
    public void setup(){
        ...
        var indexOperations = this.elasticsearchOperations.indexOps(SUGGESTION);
        ...
        this.elasticsearchOperations.withRefreshPolicy(RefreshPolicy.IMMEDIATE)
                .save(suggestionData,SUGGESTION);
        var searchHits = this.elasticsearchOperations.search(this.elasticsearchOperations.matchAllQuery(),Object.class,SUGGESTION);
    ...
    public void suggestionsSuccessTest(String parameters, List<String>expectedResults){
        //api/suggestions?prefix=coffee&limit=5
