...
public class SearchTest extends AbstractTest{
    ...
    public void setup(){
        ...
        var indexOperations = this.elasticsearchOperations.indexOps(BUSINESS);
        ...
        this.elasticsearchOperations.withRefreshPolicy(RefreshPolicy.IMMEDIATE)
                .save(businessData,BUSINESS);
        var searchHits = this.elasticsearchOperations.search(this.elasticsearchOperations.matchAllQuery(),Object.class,BUSINESS);
